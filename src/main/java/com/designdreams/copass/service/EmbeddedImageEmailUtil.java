    ...
    public static void send(String host, String port,
        ...
        if (mapInlineImages != null && mapInlineImages.size() > 0) {
            ...
            for (String contentId : setImageID) {
                ...
                try {
                    //imageFilePath = new File("copayana_logo_gold_in_white.png").getCanonicalPath();
                    //imageFilePath = "/Users/krish/IdeaProjects/copa-api/copayana_logo_gold_in_white.png";
